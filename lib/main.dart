            ...
            SizedBox(height: 30,),
                            ...
                            children:[
                              Container(
                                ...
                                child:
                                const Icon(
                                  Icons.wifi, color: Colors.black54,size: 40,),),
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: Colors.black12, width: 2),),
                                  child:
                                  Icon(Icons.flatware, color: Colors.black54,size: 40,),),
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.black12, width: 2),),
                                child:
                                Icon(Icons.beach_access, color: Colors.black54,size: 40,),),
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.black12, width: 2),),
                                child:
                                Icon(Icons.more_horiz, color: Colors.black54,size: 40,),),
                            ],
                            ),
            Container(
              child:
